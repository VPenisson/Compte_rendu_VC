...
Une dérivée de cette méthode  appelée validation croisée leave-one-out consiste à choisir p = 1. La validation se fait donc sur un seul individu et l'apprentissage sur tous les individus sauf celui utilsé pour la validation.
