...
L'objectif, pour tout algorithme ou modèle statistique est de prédire la sortie $y$ associée à une nouvelle entrée $x$, sur la base de $d^n_1$. Cette sortie peut être quantitative, $\cal{Y} \in mathbb{R}^d' $
